...
public class WebViewInteractJS extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		webView.addJavascriptInterface(new Object(){
			...
			@JavascriptInterface
			public void callCamera() {//将被js调用
	            handler.post(new Runnable() {
	                public void run() {
	                	Log.i(TAG, "callCamera()");
	                    takePhoto("defaultPic.jpg");
	                }
	            });
	        }
		}, "defaultCamera");//the name used to expose the object in JavaScript
	}
